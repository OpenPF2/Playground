...
#include "OpenPF2PlaygroundDowntimeModeRuleSet.generated.h"

UCLASS(BlueprintType, Blueprintable)
class UOpenPF2PlaygroundDowntimeModeRuleSet final : public UObject, public IPF2ModeOfPlayRuleSet
{
	GENERATED_BODY()
...
public:
	...
	{
		// Can always transition out of downtime.
		return true;
	};
};
